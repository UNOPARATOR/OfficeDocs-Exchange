...
For more information about how to remove a server role, see the Exchange 2007 product documentation topic, [How to Remove Exchange 2007 Server Roles](/previous-versions/office/exchange-server-2007/bb124115(v=exchg.80)).
